        ...
        <el-card class="box-card">
          ...
          >
            ...
            <div class="block">
                ...
                &nbsp
                <el-button type="primary" v-if="!showall" @click="showmsg">查看所有动态</el-button>
                <el-button type="primary" v-if="showall" @click="goback">返回</el-button>
                <span>
                    &nbsp
                    <el-button type="primary" @click="delmsg" v-if="!showdel">删除动态</el-button>
                    <el-button type="primary" @click="delmsg" v-else>取消删除</el-button>
                </span>
            </div>
            <br/>
            ...
            hovercolor3: index % 2 !== 0
                ...
                >
                    ...
                    <el-button style="margin-left: 85%" v-if="showdel" @click="sureDel(item._id)">确认删除</el-button>
                </div>
            </div>
        </el-card>
    </div>
